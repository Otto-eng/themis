...
export interface UsdtBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setBCV(uint256)": FunctionFragment;
    "setBondTerms(uint8,uint256)": FunctionFragment;
    "setMinBondPrice(uint256)": FunctionFragment;
    "setStaking(address,bool)": FunctionFragment;
    "setVestingTerm(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMinBondPrice",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setVestingTerm",
    values: [BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "setBCV", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setBondTerms",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "SetBCV(address,uint256,uint256)": EventFragment;
    "SetMinBondPrice(address,uint256,uint256)": EventFragment;
    "SetVestingTerm(address,uint256,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "SetBCV"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SetMinBondPrice"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SetVestingTerm"): EventFragment;
}
...
export type SetBCVEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { sender: string; oldBCV: BigNumber; newBCV: BigNumber }
>;

export type SetBCVEventFilter = TypedEventFilter<SetBCVEvent>;

export type SetMinBondPriceEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { sender: string; oldPrice: BigNumber; newPrice: BigNumber }
>;

export type SetMinBondPriceEventFilter = TypedEventFilter<SetMinBondPriceEvent>;

export type SetVestingTermEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { sender: string; oldVestingTerm: BigNumber; newVestingTerm: BigNumber }
>;

export type SetVestingTermEventFilter = TypedEventFilter<SetVestingTermEvent>;
...
export interface UsdtBondDepository extends BaseContract {
  ...
  callStatic: {
    ...
    setBCV(_newBCV: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "SetBCV(address,uint256,uint256)"(
      sender?: string | null,
      oldBCV?: BigNumberish | null,
      newBCV?: BigNumberish | null
    ): SetBCVEventFilter;
    SetBCV(
      sender?: string | null,
      oldBCV?: BigNumberish | null,
    ...
    "SetMinBondPrice(address,uint256,uint256)"(
      sender?: string | null,
      oldPrice?: BigNumberish | null,
      newPrice?: BigNumberish | null
    ): SetMinBondPriceEventFilter;
    SetMinBondPrice(
      sender?: string | null,
      oldPrice?: BigNumberish | null,
      newPrice?: BigNumberish | null
    ...
    "SetVestingTerm(address,uint256,uint256)"(
      sender?: string | null,
      oldVestingTerm?: BigNumberish | null,
      newVestingTerm?: BigNumberish | null
    ): SetVestingTermEventFilter;
    SetVestingTerm(
      sender?: string | null,
      oldVestingTerm?: BigNumberish | null,
      newVestingTerm?: BigNumberish | null
